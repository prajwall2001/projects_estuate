...
<body>  
 <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Empowering Women with Safety</h1>
                <h3 style="color:black;">Our mission is to provide women with the tools and resources they need to feel safe and secure in any situation. From self-defense tips to emergency contacts, we&#x27;ve got you covered.</h3>
